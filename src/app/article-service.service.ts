  ...
  public articles = signal<Articles[]>([
    {
      ...
      description:
        "Dans cet article, nous allons explorer 10 conseils pratiques pour réussir vos entretiens d'embauche.",
    ...
    },
    {
      ...
      description:
        'Votre CV est souvent la première impression que vous faites sur un employeur.',
    ...
    },
    {
      ...
      description:
        'Dans cet article, nous passons en revue les erreurs les plus fréquentes commises par les candidats',
